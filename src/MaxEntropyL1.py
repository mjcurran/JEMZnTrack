...
class MaxEntropyL1(Node):
    ...
    model: Path = dvc.outs("./experiment/max-entropy-L1_augmented/ckpt_max-entropy-L1_augmented.pt")
    metrics: Path = dvc.metrics_no_cache("./experiment/max-entropy-L1_augmented_scores.json") 
